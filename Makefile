...
precheck:
	...
	cp $(RUN_DIR)/final/nl/tt_um_pettit_js_prism.nl.v $(RUN_DIR)/final/gds/tt_um_pettit_js_prism.v
	$(RUN) "cd tt/precheck && PATH=$(CURDIR)/.venv-tt/bin:\$$PATH PDK_ROOT=$$PDK_ROOT PDK=ihp-sg13g2 ../../.venv-tt/bin/python precheck.py --gds $(CURDIR)/$(RUN_DIR)/final/gds/tt_um_pettit_js_prism.gds --tech ihp-sg13g2"
